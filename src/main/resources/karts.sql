...
CREATE TABLE `karts` (
  `kar_id` int NOT NULL,
  `kar_name` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `kar_tipus` enum('basic','e-turbo') COLLATE utf8_spanish_ci DEFAULT NULL,
  `kar_preu` double DEFAULT NULL,
  PRIMARY KEY (`kar_id`)
...
INSERT INTO `karts` VALUES (1,'Mario kart','basic',1.5),(2,'Luigi kart','basic',1.5),(3,'Toad kart','basic',1),(4,'Wario kart','e-turbo',3.5),(5,'Walugi kart','e-turbo',3),(6,'Bowser kart','e-turbo',4.25);
...
-- Dump completed on 2020-02-11 14:23:14
