...
<form name="frm-kart" action="${pageContext.request.contextPath}/kart" method="POST" class="was-validated">
    ...
    <input type="hidden" name="idKart" value="${karts.id}" />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tipo" required value="${kart.type}">
                            </div>
                            <div class="form-group">
                                <label for="precio">Precio</label>
                                <input type="number" class="form-control" name="precio" required value="${kart.price}">
                            </div>
                        </div>
                    </div>
                </div>
